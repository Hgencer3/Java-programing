...
public class dArraysEquals {
    public static void main(String[] args) {
        ...
        System.out.println("cars2==cars3- " + Arrays.equals(cars2, cars3));//case sensitive
        System.out.println("cars2==cars4- " + Arrays.equals(cars2, cars4));
